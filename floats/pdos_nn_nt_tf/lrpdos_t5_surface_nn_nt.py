...
data_Nb = [np.load('nn_total_t5.npz'), np.load('Nb_d_separated_1_t5.npz')]
data_Ta = [np.load('nt_total_t5.npz'), np.load('Ta_d_separated_1_t5.npz')]
output_file = 'pdos_t5_nn_nt_surface'
xlim = (0, 9)
ylim_Nb = (-2.5, 2.5)
ylim_Ta = (-0.5, 0.5)
width = 0.5*((160 - 15) - 10)
